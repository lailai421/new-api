...
| `auditTextPaths` | `string[]` | Optional. Restricted JSON Pointer paths (RFC 6901) into normalized `requestBody` for prompt audit. Required for submit plugins when prompt audit is enabled. |
